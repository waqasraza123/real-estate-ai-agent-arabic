            ...
            input: [
              {
                content: [
                  {
                    text:
                      "You are the case agent for a bilingual real-estate operating system. Return one structured decision only. Respect hard business boundaries, never invent facts, never promise discounts, legal guarantees, approvals, or outcomes, and keep WhatsApp copy concise and human.",
                    type: "input_text"
                  }
                ],
                role: "system"
